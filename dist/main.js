...
const http = new MakeHTTPRequest();
...
function searchEmployee(){
    ...
    const arrTrans = []
    let found = false
    _http__WEBPACK_IMPORTED_MODULE_0__.http.get(`https://my-json-server.typicode.com/owuracoder/employeeList/employees`)
        .then(data => {
            data.forEach((dataEl) =>{
                ...
                if(tempElf === tempNameSearch || tempEls === tempNameSearch){
                    ...
                    _ui__WEBPACK_IMPORTED_MODULE_1__.userInterface.displayEmployees(arrTrans)
            ...
            if(found === false){
                if(document.getElementById('sub-container')){
                    document.getElementById('sub-container').remove()
                    _ui__WEBPACK_IMPORTED_MODULE_1__.userInterface.showAlert('No Eployee found','success')
                    document.getElementById('search-box').value = ''
                }else {
                    _ui__WEBPACK_IMPORTED_MODULE_1__.userInterface.showAlert('No Eployee found','success')
                    document.getElementById('search-box').value = ''
...
function employeeInfo(){
   ...
   _http__WEBPACK_IMPORTED_MODULE_0__.http.get('https://my-json-server.typicode.com/owuracoder/employeeList/employees')
    .then(data => _ui__WEBPACK_IMPORTED_MODULE_1__.userInterface.displayEmployees(data))
...
function registerNewEmployee(e){
    ...
    if(firstName !== '' && surName !== '' && dob !== ''){
        ...
        if(hiddenIdInput === ''){
            _http__WEBPACK_IMPORTED_MODULE_0__.http.post('https://my-json-server.typicode.com/owuracoder/employeeList/employees', data)
            .then(resp => {
                _ui__WEBPACK_IMPORTED_MODULE_1__.userInterface.clearFields()
                _ui__WEBPACK_IMPORTED_MODULE_1__.userInterface.displayEmployees(resp)
                document.getElementById('new-employee').classList.remove('register')
            }).catch(err => console.log(err))
        }else {
            _http__WEBPACK_IMPORTED_MODULE_0__.http.put(`https://my-json-server.typicode.com/owuracoder/employeeList/employees/${hiddenIdInput}`, data)
            .then(resp => {
                _ui__WEBPACK_IMPORTED_MODULE_1__.userInterface.clearFields()
                _ui__WEBPACK_IMPORTED_MODULE_1__.userInterface.displayEmployees(resp)
                _ui__WEBPACK_IMPORTED_MODULE_1__.userInterface.refreshState()
                document.getElementById('new-employee').classList.remove('register')
            }).catch(err => console.log(err))
        }

    }else {
        _ui__WEBPACK_IMPORTED_MODULE_1__.userInterface.showAlert('Fiels cannot be empty','success')
    }
...
function removeEmployee(e){
    if(e.target.parentElement.classList.contains('del-handler')){
        ...
        if(confirm('are you sure you want to delete')){
            _http__WEBPACK_IMPORTED_MODULE_0__.http["delete"](`https://my-json-server.typicode.com/owuracoder/employeeList/employees/${id}`)
                .catch(err => {
                    console.log(err)
                })
            employeeInfo()
...
function editState(e){
    if(e.target.parentElement.classList.contains('edit-handler')){
        ...
        const dob = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(year, month, day), 'yyy-MM-dd')
        ...
        _ui__WEBPACK_IMPORTED_MODULE_1__.userInterface.populateForm(data)
