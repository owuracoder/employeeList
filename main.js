...
function searchEmployee(){
    ...
    const arrTrans = []
    let found = false
    _http__WEBPACK_IMPORTED_MODULE_0__.http.get(`http://localhost:3000/employees`)
        .then(data => {
            data.forEach((dataEl) =>{
...
function registerNewEmployee(e){
    ...
    if(firstName !== '' && surName !== '' && dob !== ''){
        ...
        if(hiddenIdInput === ''){
            _http__WEBPACK_IMPORTED_MODULE_0__.http.post('http://localhost:3000/employees', data)
            .then(resp => {
            ...
            _http__WEBPACK_IMPORTED_MODULE_0__.http.put(`http://localhost:3000/employees/${hiddenIdInput}`, data)
            .then(resp => {
                _ui__WEBPACK_IMPORTED_MODULE_1__.userInterface.clearFields()
                _ui__WEBPACK_IMPORTED_MODULE_1__.userInterface.displayEmployees(resp)
...
function removeEmployee(e){
    if(e.target.parentElement.classList.contains('del-handler')){
        ...
        if(confirm('are you sure you want to delete')){
            _http__WEBPACK_IMPORTED_MODULE_0__.http["delete"](`http://localhost:3000/employees/${id}`)
                .catch(err => {
                    console.log(err)
                })
            employeeInfo()
