...
function editState(e){
    if(e.target.parentElement.classList.contains('edit-handler')){
        ...
        let dob = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(year, month, day), 'yyy-MM-dd')
